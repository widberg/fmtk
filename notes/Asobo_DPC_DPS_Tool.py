...
def export_data_type5(in_file_path, out_folder_path):
    '''
    Function for exporting data from DPS files
    '''    
    bd_logger("Starting export_data_type5...")    
    ...
    dpc_file.close()
    bd_logger("Ending export_data_type5...")       
...
def main():
    ...
    # 4 - export data from those games:
    #       *  	FUEL PC (v1.381.65.09 / v1.381.67.09)    
    ...
    if main_switch == 1:
        ...
        p_in_file_path = "D:\\SteamLibrary\\steamapps\\common\\FUEL\\WORLD\\USA1_REGION_HABILLAGE_CR54_94A0D43D.DPC"
        p_out_folder_path = "C:\\Users\\jared\\Desktop\\dpc\\"            
        export_data_type5(p_in_file_path, p_out_folder_path)          
