/* Generated by re2c 3.0 on Mon Jan  2 22:40:11 2023 */
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // struct_body
      char dummy3[sizeof (std::vector<StructMember>)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.move< std::vector<StructMember> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<StructMember>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<StructMember>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.template destroy< std::vector<StructMember> > ();
        break;
  ...
  Parser::yytranslate_ (int t) YY_NOEXCEPT
  {
    ...
    translate_table[] =
    {
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      20,    21,     2,     2,    17,    22,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    16,    15,
       2,     2,    23,    12,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,    11,     2,    19,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    13,    18,    14,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.copy< std::vector<StructMember> > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.move< std::vector<StructMember> > (YY_MOVE (s.value));
        break;
...
namespace pigeon {
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.YY_MOVE_OR_COPY< std::vector<StructMember> > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.move< std::vector<StructMember> > (YY_MOVE (that.value));
        break;
  ...
  Parser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.copy< std::vector<StructMember> > (that.value);
        break;
  ...
  Parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        value.move< std::vector<StructMember> > (that.value);
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      ...
      case symbol_kind::S_struct_body: // struct_body
        yylhs.value.emplace< std::vector<StructMember> > ();
        break;
  ...
  case 4: // stmt: "enum" IDENTIFIER docspec '{' enum_body '}' ';'
                                                      { ctx->current_namespace->add_type(yystack_[5].value.as < std::string > (), std::shared_ptr<Type>((Type*)new EnumType(yystack_[2].value.as < std::vector<std::string> > ())));}
    break;

  case 5: // stmt: "struct" IDENTIFIER docspec '{' struct_body '}' ';'
                                                          { ctx->current_namespace->add_type(yystack_[5].value.as < std::string > (), std::shared_ptr<Type>((Type*)new StructType(yystack_[2].value.as < std::vector<StructMember> > ())));}
    break;
  ...
  case 7: // $@1: %empty
                                     { ctx->current_namespace = ctx->current_namespace->emplace_namespace(yystack_[1].value.as < std::string > ());}
    break;
  ...
  case 15: // struct_body: struct_body ',' IDENTIFIER ':' type docspec
                                                  { yystack_[5].value.as < std::vector<StructMember> > ().push_back({yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::shared_ptr<Type> > ()}); yylhs.value.as < std::vector<StructMember> > () = yystack_[5].value.as < std::vector<StructMember> > (); }
    break;

  case 16: // struct_body: struct_body ','
                      { yylhs.value.as < std::vector<StructMember> > () = yystack_[1].value.as < std::vector<StructMember> > (); }
    break;

  case 17: // struct_body: IDENTIFIER ':' type docspec
                                  { yylhs.value.as < std::vector<StructMember> > () = std::vector<StructMember>({{yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::shared_ptr<Type> > ()}}); }
    break;

  case 18: // struct_body: %empty
             { yylhs.value.as < std::vector<StructMember> > () = std::vector<StructMember>(); }
    break;
  ...
  case 22: // type: '?' type
    { yylhs.value.as < std::shared_ptr<Type> > () = std::shared_ptr<Type>((Type*)new OptionalType(yystack_[0].value.as < std::shared_ptr<Type> > ())); }
    break;
  ...
  case 24: // type: '(' struct_body ')' '-' '>' '(' struct_body ')'
    { yylhs.value.as < std::shared_ptr<Type> > () = std::shared_ptr<Type>((Type*)new FunctionType(yystack_[6].value.as < std::vector<StructMember> > (), yystack_[1].value.as < std::vector<StructMember> > ())); }
    break;

  case 25: // type: '(' type ')'
    { yylhs.value.as < std::shared_ptr<Type> > () = yystack_[1].value.as < std::shared_ptr<Type> > (); }
    break;
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -33,    41,   -33,    -5,     6,    -2,    13,    14,   -33,    -2,
       4,   -33,    -2,     9,    12,     4,     4,    21,    45,    42,
     -33,    40,    17,    -7,    54,    39,    46,   -33,   -33,   -33,
      57,    -2,    58,    43,   -33,     4,   -33,    59,    50,     4,
      23,    -3,    48,    44,    51,    36,   -33,   -33,    53,    66,
     -33,    -2,    52,   -33,    55,    25,   -33,     4,    -3,    59,
     -33,   -33,   -33,   -33,    31,    56,   -33,   -33
  };
  ...
  {
       3,     0,     1,     0,     0,     0,     0,     0,     2,     0,
      20,    21,     0,    18,     0,    20,    20,     0,     0,     0,
      22,     0,     0,     0,     0,     0,     0,     7,    10,    19,
      14,     0,    16,     0,    25,    20,    23,    18,     0,    20,
       0,    20,     0,     0,     0,     0,     3,    13,     0,    12,
      17,     0,     0,     6,     0,     0,     4,    20,    20,    18,
       5,     8,    11,    15,     0,     0,    24,     9
  };
  ...
  Parser::yypgoto_[] =
  {
     -33,    27,   -33,   -33,   -33,   -33,   -32,   -15,    -6
  };

  const signed char
  Parser::yydefgoto_[] =
  {
       0,     1,     8,    38,    65,    40,    22,    19,    14
  };

  const signed char
  Parser::yytable_[] =
  {
      26,    27,    11,    17,    25,    45,    20,    23,    25,    10,
      12,     9,    21,    11,    34,    18,    15,    16,    13,    24,
      44,    12,    18,    25,    47,    41,    50,    64,     3,    13,
       4,     5,    25,     6,    32,     7,    28,    48,    33,    61,
      49,     2,    62,    63,     3,    58,     4,     5,    32,     6,
      54,     7,    66,    32,    29,    30,    31,    35,    36,    37,
      39,    42,    21,    46,    51,    43,    53,    52,    56,    57,
      60,    67,    59,    55
  };
  ...
  Parser::yycheck_[] =
  {
      15,    16,     4,     9,    11,    37,    12,    13,    11,     3,
      12,    16,     3,     4,    21,    18,     3,     3,    20,     7,
      35,    12,    18,    11,    39,    31,    41,    59,     3,    20,
       5,     6,    11,     8,    17,    10,    15,    14,    21,    14,
      17,     0,    57,    58,     3,    51,     5,     6,    17,     8,
      14,    10,    21,    17,     9,    13,    16,     3,    19,    13,
       3,     3,     3,    13,    16,    22,    15,    23,    15,     3,
      15,    15,    20,    46
  };
  ...
  Parser::yystos_[] =
  {
       0,    25,     0,     3,     5,     6,     8,    10,    26,    16,
       3,     4,    12,    20,    32,     3,     3,    32,    18,    31,
      32,     3,    30,    32,     7,    11,    31,    31,    15,     9,
      13,    16,    17,    21,    21,     3,    19,    13,    27,     3,
      29,    32,     3,    22,    31,    30,    13,    31,    14,    17,
      31,    16,    23,    15,    14,    25,    15,     3,    32,    20,
      15,    14,    31,    31,    30,    28,    21,    15
  };
  ...
  "\"namespace\"", "'['", "'?'", "'{'", "'}'", "';'", "':'", "','", "'|'",
  "']'", "'('", "')'", "'-'", "'>'", "$accept", "slist", "stmt", "$@1",
  "$@2", "enum_body", "struct_body", "docspec", "type", YY_NULLPTR
  };
#endif
  ...
  Parser::yyrline_[] =
  {
       0,   299,   299,   300,   304,   305,   306,   307,   307,   307,
     308,   312,   313,   314,   315,   319,   320,   321,   322,   326,
     327,   331,   332,   334,   336,   338
  };
