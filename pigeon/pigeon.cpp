/* Generated by re2c 3.0 on Mon Jan  2 18:38:46 2023 */
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_23_1 = 23,                             // $@1
        S_24_2 = 24,                             // $@2
        S_enum_body = 25,                        // enum_body
        S_struct_body = 26,                      // struct_body
        S_docspec = 27,                          // docspec
        S_type = 28                              // type
      };
    };
...
namespace pigeon {
  ...
  case 10: // enum_body: enum_body ',' IDENTIFIER docspec
  ...
  case 11: // enum_body: enum_body ','
                    { yylhs.value.as < std::vector<std::string> > () = yystack_[1].value.as < std::vector<std::string> > (); }
    break;

  case 12: // enum_body: IDENTIFIER docspec
                         { yylhs.value.as < std::vector<std::string> > () = std::vector<std::string>({yystack_[1].value.as < std::string > ()}); }
    break;

  case 13: // enum_body: %empty
             { yylhs.value.as < std::vector<std::string> > () = std::vector<std::string>(); }
    break;

  case 14: // struct_body: struct_body ',' IDENTIFIER docspec ':' type
                                                  { yystack_[5].value.as < std::vector<StructMember> > ().push_back({yystack_[3].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<Type> > ()}); yylhs.value.as < std::vector<StructMember> > () = yystack_[5].value.as < std::vector<StructMember> > (); }
    break;

  case 15: // struct_body: struct_body ','
                      { yylhs.value.as < std::vector<StructMember> > () = yystack_[1].value.as < std::vector<StructMember> > (); }
    break;

  case 16: // struct_body: IDENTIFIER docspec ':' type
                                  { yylhs.value.as < std::vector<StructMember> > () = std::vector<StructMember>({{yystack_[3].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<Type> > ()}}); }
    break;

  case 17: // struct_body: %empty
  ...
  case 21: // type: '?' type
    { yylhs.value.as < std::shared_ptr<Type> > () = std::shared_ptr<Type>((Type*)new pigeon::OptionalType(yystack_[0].value.as < std::shared_ptr<Type> > ())); }
    break;

  case 22: // type: type '[' ']'
    { yylhs.value.as < std::shared_ptr<Type> > () = std::shared_ptr<Type>((Type*)new pigeon::ArrayType(yystack_[2].value.as < std::shared_ptr<Type> > ())); }
    break;
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -12,     3,   -12,     1,     2,     7,    20,   -12,    -3,   -12,
       2,    14,    -3,    -3,    15,    17,   -12,    25,    16,    19,
     -12,   -12,    33,    -3,   -12,    34,    26,    -3,    -9,    23,
      -3,    13,   -12,   -12,    27,    37,   -12,    28,    29,    40,
      12,   -12,    -3,     2,   -12,    -3,   -12,   -12,    35,    30,
      36,     2,   -12,    35
  };
  ...
  Parser::yydefact_[] =
  {
       3,     0,     1,     0,     0,     0,     0,     2,    19,    20,
       0,     0,    19,    19,     0,     0,    21,     0,     0,     0,
       7,    18,    13,    19,    22,    17,     0,    19,     0,     0,
      19,     0,     3,    12,     0,    11,     6,     0,     0,    15,
       0,     4,    19,     0,     5,    19,     8,    10,    16,     0,
       0,     0,     9,    14
  };
  ...
  Parser::yypgoto_[] =
  {
     -12,    18,   -12,   -12,   -12,   -12,   -12,   -11,   -10
  };

  const signed char
  Parser::yydefgoto_[] =
  {
       0,     1,     7,    26,    50,    28,    31,    15,    11
  };

  const signed char
  Parser::yytable_[] =
  {
      16,    19,    20,     2,     8,    34,     9,    35,     3,     4,
      12,     5,    29,     6,    10,    14,    33,     3,     4,    37,
       5,    17,     6,    13,    21,    18,    46,    38,    23,    39,
      22,    47,    25,    48,    49,    24,    27,    30,    36,    32,
      42,    53,    41,    45,    44,    43,    18,    51,     0,     0,
      40,    52
  };
  ...
  Parser::yycheck_[] =
  {
      10,    12,    13,     0,     3,    14,     4,    16,     5,     6,
       3,     8,    23,    10,    12,    18,    27,     5,     6,    30,
       8,     7,    10,     3,     9,    11,    14,    14,     3,    16,
      13,    42,    13,    43,    45,    19,     3,     3,    15,    13,
       3,    51,    15,     3,    15,    17,    11,    17,    -1,    -1,
      32,    15
  };
  ...
  Parser::yystos_[] =
  {
       0,    21,     0,     5,     6,     8,    10,    22,     3,     4,
      12,    28,     3,     3,    18,    27,    28,     7,    11,    27,
      27,     9,    13,     3,    19,    13,    23,     3,    25,    27,
       3,    26,    13,    27,    14,    16,    15,    27,    14,    16,
      21,    15,     3,    17,    15,     3,    14,    27,    28,    27,
      24,    17,    15,    28
  };
  ...
  "\"namespace\"", "'['", "'?'", "'{'", "'}'", "';'", "','", "':'", "'|'",
  "']'", "$accept", "slist", "stmt", "$@1", "$@2", "enum_body",
  "struct_body", "docspec", "type", YY_NULLPTR
  };
#endif
  ...
  Parser::yyrline_[] =
  {
       0,   238,   238,   239,   243,   244,   245,   246,   246,   246,
     250,   251,   252,   253,   257,   258,   259,   260,   264,   265,
     269,   270,   272
  };
