/* Generated by re2c 3.0 on Fri Dec 30 19:03:49 2022 */
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_slist = 14,                            // slist
        S_stmt = 15,                             // stmt
        S_enum_body = 16,                        // enum_body
        S_struct_body = 17,                      // struct_body
        S_docspec = 18                           // docspec
      };
    };
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::END_OF_FILE
                   ...
                   || (token::ENUM <= tok && tok <= token::DEPRICATED)
                   || tok == 123
                   || tok == 125
                   || tok == 59
                   || tok == 44
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -10,     1,   -10,     6,     8,   -10,    -9,    -9,     7,     5,
       9,   -10,    11,    12,    -9,    -6,    10,     0,   -10,    13,
      14,    16,    15,    17,   -10,    -9,   -10,   -10,    18,   -10,
      20,   -10
  };
  ...
  Parser::yydefact_[] =
  {
       3,     0,     1,     0,     0,     2,    15,    15,     0,     0,
       0,    14,     9,    13,    15,     0,     0,     0,     8,     0,
       7,     0,     0,    11,     4,    15,    12,     5,     0,     6,
       0,    10
  };
  ...
  Parser::yytable_[] =
  {
      10,     2,    19,     8,    20,     3,     4,    18,    22,     6,
      23,     7,    12,    11,    14,    16,    13,    25,    29,    26,
      28,    21,    24,    31,    27,     0,     0,     0,     0,    30
  };

  const signed char
  Parser::yycheck_[] =
  {
       7,     0,     8,    12,    10,     4,     5,    14,     8,     3,
      10,     3,     7,     6,     3,     3,     7,     3,    25,     3,
       3,    11,     9,     3,     9,    -1,    -1,    -1,    -1,    11
  };

  const signed char
  Parser::yystos_[] =
  {
       0,    14,     0,     4,     5,    15,     3,     3,    12,    18,
      18,     6,     7,     7,     3,    16,     3,    17,    18,     8,
      10,    11,     8,    10,     9,     3,     3,     9,     3,    18,
      11,     3
  };
  ...
  {
  "END_OF_FILE", "error", "\"invalid token\"", "IDENTIFIER", "\"enum\"",
  "\"struct\"", "\"depricated\"", "'{'", "'}'", "';'", "','", "':'", "'|'",
  "$accept", "slist", "stmt", "enum_body", "struct_body", "docspec", YY_NULLPTR
  };
#endif
