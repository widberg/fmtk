/* Generated by re2c 3.0 on Mon Jan  2 18:24:55 2023 */
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      // TYPE
      // type
      char dummy1[sizeof (std::shared_ptr<pigeon::Type>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_24_2 = 24,                             // $@2
        S_25_3 = 25,                             // $@3
        S_enum_body = 26,                        // enum_body
        S_struct_body = 27,                      // struct_body
        S_docspec = 28,                          // docspec
        S_type = 29                              // type
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_type: // type
        value.move< std::shared_ptr<pigeon::Type> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<pigeon::Type>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<pigeon::Type>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.template destroy< std::shared_ptr<pigeon::Type> > ();
        break;
...
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, std::shared_ptr<pigeon::Type> v, location_type l)
        : super_type (token_kind_type (tok), std::move (v), std::move (l))
#else
      symbol_type (int tok, const std::shared_ptr<pigeon::Type>& v, const location_type& l)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_TYPE (std::shared_ptr<pigeon::Type> v, location_type l)
      {
      ...
      static
      symbol_type
      make_TYPE (const std::shared_ptr<pigeon::Type>& v, const location_type& l)
      {
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.copy< std::shared_ptr<pigeon::Type> > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.move< std::shared_ptr<pigeon::Type> > (YY_MOVE (s.value));
        break;
...
namespace pigeon {
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.YY_MOVE_OR_COPY< std::shared_ptr<pigeon::Type> > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.move< std::shared_ptr<pigeon::Type> > (YY_MOVE (that.value));
        break;
  ...
  Parser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.copy< std::shared_ptr<pigeon::Type> > (that.value);
        break;
  ...
  Parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        value.move< std::shared_ptr<pigeon::Type> > (that.value);
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      case symbol_kind::S_TYPE: // TYPE
      case symbol_kind::S_type: // type
        yylhs.value.emplace< std::shared_ptr<pigeon::Type> > ();
        break;
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 4: // $@1: %empty
                                                  { ctx->current_namespace->add_type(yystack_[4].value.as < std::string > (), std::shared_ptr<Type>((Type*)new EnumType(yystack_[1].value.as < std::vector<std::string> > ())));}
    break;
  ...
  case 21: // type: TYPE
      { yylhs.value.as < std::shared_ptr<pigeon::Type> > () = yystack_[0].value.as < std::shared_ptr<pigeon::Type> > (); }
    break;

  case 22: // type: '?' type
    { yylhs.value.as < std::shared_ptr<pigeon::Type> > () = std::shared_ptr<Type>((Type*)new pigeon::OptionalType(yystack_[0].value.as < std::shared_ptr<pigeon::Type> > ())); }
    break;

  case 23: // type: type '[' ']'
    { yylhs.value.as < std::shared_ptr<pigeon::Type> > () = std::shared_ptr<Type>((Type*)new pigeon::ArrayType(yystack_[2].value.as < std::shared_ptr<pigeon::Type> > ())); }
    break;
...
#undef YYCASE_
  ...
  Parser::yypact_[] =
  {
     -13,     3,   -13,     1,     6,    18,    19,   -13,   -12,   -13,
       6,    13,   -12,   -12,    16,    17,   -13,    26,    14,    21,
     -13,   -13,    29,   -12,   -13,    32,    23,   -12,    -9,    22,
      24,    12,   -13,   -13,   -13,    35,   -13,     6,    25,    39,
       9,    28,   -12,    33,   -13,    30,   -13,   -13,   -13,     6,
      31,    33,   -13
  };
  ...
  Parser::yydefact_[] =
  {
       3,     0,     1,     0,     0,     0,     0,     2,    20,    21,
       0,     0,    20,    20,     0,     0,    22,     0,     0,     0,
       8,    19,    14,    20,    23,    18,     0,    20,     0,     0,
       0,     0,     3,    13,     4,    12,     7,     0,     0,    16,
       0,     0,    20,    17,     6,     0,     9,     5,    11,     0,
       0,    15,    10
  };
  ...
  Parser::yypgoto_[] =
  {
     -13,    20,   -13,   -13,   -13,   -13,   -13,   -13,   -11,   -10
  };

  const signed char
  Parser::yydefgoto_[] =
  {
       0,     1,     7,    41,    26,    50,    28,    31,    15,    11
  };

  const signed char
  Parser::yytable_[] =
  {
      16,    19,    20,     2,     8,    34,    14,    35,     3,     4,
       9,     5,    29,     6,     3,     4,    33,     5,    10,     6,
      17,    12,    13,    46,    18,    21,    38,    43,    39,    23,
      22,    48,    27,    24,    25,    30,    32,    36,    42,    51,
      44,    37,    45,    47,    18,     0,    52,    49,     0,     0,
       0,     0,    40
  };
  ...
  Parser::yycheck_[] =
  {
      10,    12,    13,     0,     3,    14,    18,    16,     5,     6,
       4,     8,    23,    10,     5,     6,    27,     8,    12,    10,
       7,     3,     3,    14,    11,     9,    14,    37,    16,     3,
      13,    42,     3,    19,    13,     3,    13,    15,     3,    49,
      15,    17,     3,    15,    11,    -1,    15,    17,    -1,    -1,
      -1,    -1,    32
  };
  ...
  Parser::yystos_[] =
  {
      ...
      12,    29,     3,     3,    18,    28,    29,     7,    11,    28,
      28,     9,    13,     3,    19,    13,    24,     3,    26,    28,
       3,    27,    13,    28,    14,    16,    15,    17,    14,    16,
      21,    23,     3,    29,    15,     3,    14,    15,    28,    17,
      25,    29,    15
  };
  ...
  Parser::yyr1_[] =
  {
       0,    20,    21,    21,    23,    22,    22,    22,    24,    25,
      22,    26,    26,    26,    26,    27,    27,    27,    27,    28,
      28,    29,    29,    29
  };
  ...
  "\"namespace\"", "'['", "'?'", "'{'", "'}'", "';'", "','", "':'", "'|'",
  "']'", "$accept", "slist", "stmt", "$@1", "$@2", "$@3", "enum_body",
  ...
  Parser::yyrline_[] =
  {
       0,   219,   219,   220,   224,   224,   225,   226,   227,   227,
     227,   231,   232,   233,   234,   238,   239,   240,   241,   245,
     246,   250,   251,   253
  };
