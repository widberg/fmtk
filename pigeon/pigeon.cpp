/* Generated by re2c 3.0 on Sun Jan  8 16:38:30 2023 */
...
namespace pigeon {
  ...
  case 6: // stmt: "use" type "as" IDENTIFIER docspec ';'
                                             {ctx->current_namespace->add_type(yystack_[2].value.as < std::string > (), std::shared_ptr<Type>((Type*)new TypeDefType(yystack_[4].value.as < std::shared_ptr<Type> > (), yystack_[2].value.as < std::string > ())));}
    break;
...
#undef YYCASE_
  ...
  Parser::yyrline_[] =
  {
       0,   650,   650,   651,   655,   656,   657,   658,   658,   658,
     659,   663,   664,   665,   666,   670,   671,   672,   673,   677,
     678,   682,   683,   685,   687
  };
